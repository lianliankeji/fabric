...
// restfull
app.get('/ehr/deploy',function(req, res){  
        ...
        if (err) {
            ...
            user.getUserCert(attr, function (err, userCert) {
                ...
                var deployRequest = {
                    ...
                    fcn: "init",
                    args: [],
                    chaincodePath: "/usr/local/llwork/api/health"
                };
...
app.get('/ehr/invoke', function(req, res) { 
...
app.get('/ehr/query', function(req, res) { 
